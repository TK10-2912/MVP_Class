    ...
    render() {
        ...
        return (
            <>
                <Modal
                    width={'80%'}
                    title={<h3 style={{ textAlign: 'center' }}>{this.props.transaction != undefined && ` Chi tiết đơn hàng: ${this.props.transaction.ma_hoa_don} của máy "${this.props.transaction.ten_may}" thuộc nhóm máy "${this.props.transaction.ten_nhom}"`}  </h3>}
