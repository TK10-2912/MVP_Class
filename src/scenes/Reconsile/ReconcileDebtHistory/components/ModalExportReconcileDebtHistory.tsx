...
import TableReconcileDebtHistory from './TableReconcileDebtHistory';
...
export default class ModalExportReconcileDebtHistory extends React.Component<IProps> {
		...
		return (
			<Modal
				...
				title={
					<Row>
						<Col span={12}>
							<h2>{L('Xuất dữ liệu') + L(' danh sách lịch sử công nợ')}</h2>
						</Col>
			...
			>
				...
				<Col ref={this.setComponentRef} id='reconcile_debt_id' span={24} style={{ marginTop: '10px' }} >
					<TitleTableModalExport title='Danh sách lịch sử đối soát công nợ'></TitleTableModalExport>
