                    ...
                    <Row >
                        ...
                        <Col span={12} style={{ textAlign: 'end' }}>
                            <ActionExport
                                ...
                                idPrint={(this.state.isPrintTableBillingViewUser && this.state.isPrintTableListBillingOnlyInExcelUser) ? "bank_reconcile_admin_detail_print_id" : (this.state.isPrintTableBillingViewUser && this.state.isPrintTableListBillingOnlyInExcelUser === false) ? "bank_reconcile_1" : (this.state.isPrintTableBillingViewUser === false && this.state.isPrintTableListBillingOnlyInExcelUser) ? "bank_reconcile_2" : "bank_reconcile_user_detail_print_id"}
                                isExcel={true}
                                isWord={true}
