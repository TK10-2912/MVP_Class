...
export default class TableBillingRFIDSystemAdmin extends React.Component<IProps> {
    ...
    render() {
        ...
        const columns: ColumnsType<BillingDto> = [
            ...
            { title: "Thời giao dịch", key: "ma_id_bill_index", render: (text: string, item: BillingDto) => <div> {moment(item.bi_created_at).format("DD/MM/YYYY HH:mm:ss")} </div> },
        ]
        ...
        return (
            <>
                ...
                <Table
                    ...
                    dataSource={(this.state.bi_code_search == undefined || this.state.bi_code_search != undefined) ? this.listDataBill : this.listDataBillFill}
