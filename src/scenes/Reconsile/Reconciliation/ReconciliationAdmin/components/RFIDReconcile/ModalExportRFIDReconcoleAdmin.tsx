...
export default class ModalExportRFIDReconcolelAdmin extends React.Component<IProps> {
    ...
    render() {
        ...
        return (
                ...
                title={
                    <Row >
                        ...
                        <Col span={12} style={{ textAlign: 'end' }}>
                            <ActionExport
                                nameFileExport={'bank_reconcile_admin' + ' ' + moment().format('DD_MM_YYYY')}
                                idPrint="bank_reconcile_admin_print_id"
                                isExcel={true}
                                isWord={true}
            ...
            >
                <Col ref={this.setComponentRef} span={24} style={{ marginTop: '10px' }} id="bank_reconcile_admin_print_id">
