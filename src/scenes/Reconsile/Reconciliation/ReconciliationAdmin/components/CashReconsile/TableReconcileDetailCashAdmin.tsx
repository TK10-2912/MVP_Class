import { CheckCircleOutlined, EyeFilled, SyncOutlined } from "@ant-design/icons";
...
export default class TableReconcileDetailCashAdmin extends React.Component<IProps> {
    state = {
    ...
    render() {
        ...
        const columns: ColumnsType<ReconcileDto> = [
            ...
            {
                title: "Trạng thái", key: "rec_customer_is_confirmed", render: (text: string, item: ReconcileDto) => {
            ...
            { title: "Thời gian tạo đối soát", key: "money", render: (text: string, item: ReconcileDto) => <div> {moment(item.rec_created_at).format("DD/MM/YYYY HH:mm:ss")}</div> },
