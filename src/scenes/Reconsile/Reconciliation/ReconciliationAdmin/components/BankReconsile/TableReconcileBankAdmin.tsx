...
export default class TableReconcileBankAdmin extends React.Component<IProps> {
    ...
    render() {
        ...
        const { listReconsile, is_printed, hasAction, pagination } = this.props;
        const columns: ColumnsType<ReconcileDto> = [
            ...
            {
                title: "Trạng thái", key: "rec_customer_is_confirmed", width: 280, render: (text: string, item: ReconcileDto) => {
