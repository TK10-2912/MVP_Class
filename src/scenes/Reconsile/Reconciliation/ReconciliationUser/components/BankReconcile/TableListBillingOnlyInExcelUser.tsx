...
export default class TableListBillingOnlyInExcelUser extends React.Component<IProps> {
    state = {
        isLoadDone: true,
        ex_code: undefined,
    ...
    render() {
        ...
        const columns: ColumnsType<ExcelReconcileDto> = [
            ...
            {
                title: "Số tiền thanh toán", key: "ex_money", width: 150, render: (text: string, item: ExcelReconcileDto, index: number) =>
            ...
            <>
                <Row gutter={[8, 8]} align='bottom' style={{ marginTop: 20 }}>
                    <Col span={24} style={{ display: "flex", justifyContent: "center" }}>
                        <TitleTableModalExport title='Danh sách đơn hàng chỉ có trong Excel'></TitleTableModalExport>
                    </Col>
                    {
                ...
                <Table
                    ...
                    scroll={(hasAction != undefined && hasAction === true) ? { x: 1400, y: 'auto' } : { x: undefined, y: undefined }}
                    columns={columns}
                    size={'small'}
                    bordered={true}
