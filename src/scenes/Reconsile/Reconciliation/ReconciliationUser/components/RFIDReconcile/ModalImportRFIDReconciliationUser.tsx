...
import { AttachmentItem, BillingDto, ExcelReconcileBankInput, ExcelReconcileRFIDInput, FileDto, FileParameter, ReconcileBankInput, ReconcileInput, ReconcileRFIDInput } from '@src/services/services_autogen';
...
const { confirm } = Modal;
const { Option } = Select;
export default class ModalImportRFIDReconciliationUser extends React.Component<IProps> {
    state = {
        isLoadDone: false,
        checkFile: false,
