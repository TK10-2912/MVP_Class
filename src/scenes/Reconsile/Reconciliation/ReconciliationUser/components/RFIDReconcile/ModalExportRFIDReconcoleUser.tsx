...
import { ReconcileDto, TransactionByMachineDto } from '@src/services/services_autogen';
import { Col, Modal, Row } from 'antd';
import moment from 'moment';
import * as React from 'react';
import TableReconcileBankUser from './TableReconcileRFIDUser';
...
export default class ModalExportRFIDReconcolelUser extends React.Component<IProps> {
