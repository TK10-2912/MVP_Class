...
import { CheckCircleOutlined, CheckOutlined, EyeFilled, FileDoneOutlined, FileSearchOutlined, MoneyCollectOutlined, SyncOutlined } from "@ant-design/icons";
...
export default class TableReconcileRFIDUser extends React.Component<IProps> {
    state = {
        visibleModal: false,
    }
        ...
        let action: ColumnGroupType<ReconcileDto> = {
            ...
            render: (text: string, item: ReconcileDto) => (
                <Space>
                    ...
                    {isGranted(AppConsts.Permission.Pages_Reconcile_Reconcile_DetailRechargeRFID) &&
                        <Button
