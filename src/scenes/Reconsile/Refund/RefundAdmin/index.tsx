...
import UpdateRefundAdmin from './components/UpdateRefundAdmin';
...
export default class RefundAdmin extends AppComponentBase {
	...
	async getAll() {
		...
		await stores.refundStore.getAllByAdmin(this.state.us_id_list, this.state.ref_reason_type, this.state.ref_refund_type, this.state.ref_status, this.state.bi_code, this.state.ref_nameBank, this.state.ref_from, this.state.ref_to, this.state.gr_ma_id, this.state.ma_id_list, this.state.skipCount, this.state.pageSize);
				...
				<Row style={{ marginTop: '10px' }}>
					<Col {...left} style={{ overflowY: "auto" }}>
						<TableRefundAdmin
							...
							hasAction={this.state.visibleExportRefund ? false : true}
							pagination={{
