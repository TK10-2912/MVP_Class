...
import { Col, Row, Button, Card, Form, message, Space, Carousel } from 'antd';
import {
    RefundDto,
    AttachmentItem,
    BillingDto,
...
export default class DetailRefundAdmin extends AppComponentBase<IProps> {
                ...
                <Form style={{ width: "100%", marginTop: "10px" }}>
                    <Row gutter={10}>
                        ...
                        <Col span={9}>
                            ...
                            <Form.Item {...AppConsts.formItemLayout} style={{ borderBottom: "1px solid #cfd9d6" }} label="Số tiền đã nạp: " {...AppConsts.formItemLayout} name={'ref_money'}>
                                <strong>
                            ...
                            <Form.Item {...AppConsts.formItemLayout} style={{ borderBottom: "1px solid #cfd9d6" }} label={"Lý do hoàn tiền"} {...AppConsts.formItemLayout} name={'ref_reason_type'}>
                                <strong>
                        ...
                        <Col span={9}>
                            <Form.Item {...AppConsts.formItemLayout} style={{ borderBottom: "1px solid #cfd9d6" }} label={"Chủ tài khoản"} {...AppConsts.formItemLayout} name={'ref_nameAccountBank'}>
                                <strong>{refundSelected.ref_nameAccountBank}</strong>
                            </Form.Item>

                            <Form.Item {...AppConsts.formItemLayout} style={{ borderBottom: "1px solid #cfd9d6" }} label={"Số tài khoản"}  {...AppConsts.formItemLayout} name={'ref_codebank'}>
                                <strong>{refundSelected.ref_codebank}</strong>
                            </Form.Item>
                            <Form.Item {...AppConsts.formItemLayout} style={{ borderBottom: "1px solid #cfd9d6" }} label={"Ngân hàng"} {...AppConsts.formItemLayout} name={'ref_namebank'}>
                                <strong>{refundSelected.ref_namebank}</strong>
                            </Form.Item>

                            <Form.Item {...AppConsts.formItemLayout} label={"Lý do chi tiết"} {...AppConsts.formItemLayout} name={'ref_reason'}>
                                <strong>
