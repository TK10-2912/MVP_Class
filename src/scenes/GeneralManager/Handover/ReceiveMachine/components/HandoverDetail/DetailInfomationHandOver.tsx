...
export default class DetailInfomationHandOver extends AppComponentBase<IProps> {
    ...
    render() {
        ...
        let treeMachineHandover = stores.sessionStore.getAllTreeMachinesWithGroupMachineDetail(handoverSelected?.ha_status === eHandoverStatus.HANDOVER_COMPLETE.num ? handoverSelected?.receive_user! : handoverSelected?.handover_user!, handoverSelected?.ma_id_list!.map(Number));
        return (
            <Card>
                <Form>
                    <Row gutter={8}>
                        ...
                        <Col span={10}>
                            ...
                            <Form.Item
                                ...
                                style={{ borderBottom: "1px solid #cfd9d6" }}
                            >
                                <b>{this.handoverSelected?.ha_note!}</b>
                            </Form.Item>
