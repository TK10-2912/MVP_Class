...
import AuthorizationMachineTable from './ExportRepositoryTableUser';
import CreateOrUpdateAuthorizationMachine from './CreateExportRepositoryUser';
import ModalExportAuthorizationMachine from './ModalExportExportRepositoryUser';
...
import CreateImportRepository from './CreateExportRepositoryUser';
import ImportRepositoryTable from './ExportRepositoryTableUser';
import ExportRepositoryTable from './ExportRepositoryTableUser';
import ModalExportExportRepository from './ModalExportExportRepositoryUser';
import ExportRepositoryTableUser from './ExportRepositoryTableUser';
import CreateExportRepositoryUser from './CreateExportRepositoryUser';
import ModalExportExportRepositoryUser from './ModalExportExportRepositoryUser';
const { confirm } = Modal;

export default class ExportRepositoryUser extends React.Component {
	state = {
		isLoadDone: true,
	...
	async getAll() {
		...
		await stores.exportRepositoryStore.getAll(this.state.ma_id_list, this.state.skipCount, this.state.maxResultCount);
		...
		return (
			<Card>
				...
				<Row gutter={[8, 8]} align='bottom'>
					<Col {...cssColResponsiveSpan(24, 12, 8, 16, 16, 16)}>
				...
				<ModalExportExportRepositoryUser
