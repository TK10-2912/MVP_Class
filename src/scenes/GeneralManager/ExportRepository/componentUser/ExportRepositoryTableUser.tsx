...
import DetailProductImport from './DetailProductExportUser';
import FileAttachments from '@src/components/FileAttachments';
import DetailProductExport from './DetailProductExportUser';
import DetailProductExportUser from './DetailProductExportUser';
...
export default class ExportRepositoryTableUser extends AppComponentBase<IProps> {
	state = {
		isLoadDone: true,
		ex_re_id: undefined,
	...
	render() {
		...
		const columns: ColumnsType<ExportRepositoryDto> = [
			...
			{
				title: "Nhóm máy", sorter: true, dataIndex: "gr_ma_id", key: "ma_id_index", render: (text: number, item: ExportRepositoryDto) => <div>
			...
			{
				title: "Mã máy", sorter: true, dataIndex: "ma_code", key: "ma_id_index", render: (text: number, item: ExportRepositoryDto) => <div>
					{!this.props.actionTable ? (item.ma_id) :
			...
			{
				title: "Tên máy", sorter: true, dataIndex: "ma_id", key: "ma_id_index", render: (text: number, item: ExportRepositoryDto) => <div>
					{!this.props.actionTable ? (item.ma_id) :
		...
		return (
			<>
				...
				>
					<DetailProductExportUser productList={this.productList} />
