...
export default class ReportOfMachineAdmin extends React.Component<Iprops> {
    ...
    actionTable = async (reportMachine: ReportOfMachineDto, event: EventTable) => {
    ...
    render() {
        ...
        return (
            !!this.props.ma_id && this.state.hasData || !this.props.ma_id
                ?
                <Card>
                    <Row align="bottom">
                        <Col style={{ display: 'flex', alignItems: "bottom" }}  {...cssColResponsiveSpan(24, 24, 12, 12, 12, 12)}  >
                    ...
                    <Row gutter={[8, 8]} align="bottom" >
                            ...
                            <Col {...cssColResponsiveSpan(24, 12, 12, 8, 8, 4)}>
                                ...
                                <SelectUserMultiple
                                    ...
                                    onChangeUser={async (value) => {
                                        await this.setState({ us_id_list: value });
                                        this.onChangePage(1, this.state.pageSize);
                                    }}
                                ></SelectUserMultiple>
                            </Col>
                        ...
                        <Col {...cssColResponsiveSpan(24, 12, 12, 8, 8, 5)} style={{ alignContent: 'bottom' }}>
                            <Space>
                                {(this.props.ma_id == undefined) &&
