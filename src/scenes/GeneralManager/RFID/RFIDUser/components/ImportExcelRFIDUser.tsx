...
export default class ImportLSCFromExcelRFIDUser extends React.Component<IProps> {
            ...
            <>
                ...
                <Row>
                    <Col span={24}>
                        ...
                        >
                            <Button title={L('Tải danh sách')} style={{ width: '1000px', height: '50px' }} icon={<PlusOutlined />} type="dashed" ></Button>
                        </Upload>
                    </Col>
                </Row>
