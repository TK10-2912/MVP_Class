...
import DetailInfomationImportRepositoryUser from './ImportReponsitoryDetail/DetailInfomationImportRepositoryAdmin';
								...
								<>
									...
									<Tabs defaultActiveKey={tabManager.tab_1}>
										<Tabs.TabPane tab={tabManager.tab_1} key={tabManager.tab_1}>
											<DetailInfomationImportRepositoryUser onUpdate={() => this.onUpdate()} openBillImportRepository={() => this.openBillImportRepository(record)} onSuccess={this.onSuccess} listProductImport={record.listProductImport} importRepostitorySelected={record} />
										</Tabs.TabPane>
									</Tabs>
								</>
							),
