...
export default class CreateOrUpdateImportsitoryUser extends AppComponentBase<IProps> {
                ...
                <>
                    ...
                    <Form
                        ...
                        <Form.Item
                            label={"Tổng số lượng"}
                        >
                            <Tag><b>{AppConsts.formatNumber(this.props.listProductImport != undefined ? this.props.listProductImport.reduce((accumulator, currentValue) =>
                                accumulator + currentValue.pr_im_quantity, 0) : 0)}</b></Tag>
                        </Form.Item>
                        <Form.Item
