...
export default class DetailInfomationImportRepositoryUser extends AppComponentBase<IProps> {
            ...
            <Card >
                <Form
                    ...
                    {importRepostitorySelected?.im_re_status === 0 &&
                        <Row justify='end'>
                            <Space>
                                {(importRepostitorySelected.us_id_import === stores.sessionStore.getUserLogin().id!) &&
                                    <Button
