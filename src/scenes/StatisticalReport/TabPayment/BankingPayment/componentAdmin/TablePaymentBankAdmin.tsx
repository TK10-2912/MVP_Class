...
import { BillingDto, ItemBillingEntity, MachineDto, PaymentBankDto } from '@src/services/services_autogen';
...
export default class TablePaymentBankAdmin extends React.Component<IProps> {
	...
	render() {
		const { pagination, importingListResult, isPrinted } = this.props;
