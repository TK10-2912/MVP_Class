...
export default class BaoCaoTheoSanPhamCoBaoBiUser extends AppComponentBase {
    ...
    inputSearchProduct: SearchBillingOfProductWithMachine = new SearchBillingOfProductWithMachine(undefined, undefined, undefined, undefined, undefined, undefined, undefined, this.state.skipCount, this.state.pageSize);
    inputSearch: SearchInputUser = new SearchInputUser(undefined, undefined, undefined, undefined, undefined, undefined, this.state.skipCount, this.state.pageSize);
    ...
    getAll = async () => {
        ...
        if (!!this.inputSearchProduct.product_key) {
            ...
            await stores.statisticStore.statisticBillingOfDrinkProduct(this.inputSearchProduct);
    ...
    onChangePageProduct = async (page: number, pagesize?: number) => {
        if (pagesize !== undefined) {
                            ...
                            <BaoCaoSanPhamTheoMay
                                ...
                                pagination={{
                                    ...
                                    onShowSizeChange(current: number, size: number) {
                                        self.onChangePageProduct(current, size)
                                    },
                                    onChange: (page: number, pagesize?: number) => self.onChangePageProduct(page, pagesize)
                                }}
                            />
                            :
                            <>{isGranted(AppConsts.Permission.Pages_Statistic_FreshDrink_Export) &&
