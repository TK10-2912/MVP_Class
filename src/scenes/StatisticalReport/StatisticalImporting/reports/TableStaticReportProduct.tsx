...
export default class TableStaticReportProduct extends React.Component<IProps> {
    render() {
        const {totalBillingStatistic } = stores.statisticStore;
        ...
        const columns: ColumnsType<StatisticBillingOfProductDto> = [
            {
                ...
                key: 'stt',
                width: 50,
                render: (_: string, _item: StatisticBillingOfProductDto, index: number) => (
                    <div>
                        {pagination !== false
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        key: 'cash_count',
                        render: (_: string, item: StatisticBillingOfProductDto) => (
                            <div>{AppConsts.formatNumber(item.cash_quantity)}</div>
                        ),
                    },
                    {
                        title: 'Mã QR',
                    ...
                    },
                    {
                        ...
                        sorter: true,
                        render: (_: string, item: StatisticBillingOfProductDto) => (
                            <div>{AppConsts.formatNumber(item.qr_quantity)}</div>
                        ),
                    },
                    {
                        title: 'RFID',
            ...
            {
                title: <b>{'Số lượng sản phẩm' + this.props.type}</b>,
                key: 'totalQuantity',
                width: 100,
                sorter: true,
                render: (_: string, item: StatisticBillingOfProductDto) => (
        ...
        return (
            <>
                <Table
                    ...
                    footer={() =>
                            <Row style={{ marginTop: '8px', fontSize: 14 }} id='TableStaticReportProduct'>
                                <Col
