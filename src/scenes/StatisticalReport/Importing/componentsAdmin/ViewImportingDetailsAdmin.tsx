                    ...
                    <div style={{ maxHeight: '400px', overflowY: 'auto', width: "100%", }}>
                        {
                            this.combinedArrayVending != undefined && this.combinedArrayVending.map(({ slotId, before, after }) =>
                                <Col span={24} key={slotId} >
                                    <br />
                                    {/* <label style={{ fontWeight: 'bold', fontSize: 16 }}>Đợt nhập: {importingSelected.im_period} </label> <br />
                                <label style={{ fontWeight: 'bold', fontSize: 16 }}>Người nhập: {importingSelected.im_person_charge} </label> <br /> */}
