...
import { Button, Card, Col, Row, Space, Tabs, message } from 'antd';
import moment from 'moment';
import * as React from 'react';
import ItemProductImporting from './ItemProductImporting';
...
export default class ViewImportingDetailsAdmin extends React.Component<IProps> {
    state = {
        isLoadDone: false,
        isLoadFile: false,
    ...
    async componentDidUpdate(prevProps, prevState) {
        if (prevProps.importing_id != this.props.importing_id) {
            ...
            this.initData(this.props.importingSelected);
        }
    }
    ...
    initData = async (importing: ImportingDto | undefined) => {
        this.setState({ isLoadDone: false });
        if (importing !== undefined && importing.im_id !== undefined) {
            this.fileAttachmentItem = importing.fi_id_list!;
