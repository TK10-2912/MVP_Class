...
const { Option } = Select;
export default class SelectedGroupMachineSoftDetail extends AppComponentBase<IProps> {
    state = {
        isLoading: false,
    ...
    async componentDidMount() {
        ...
        this.groupMachine.unshift(
            GroupMachineAbstractDto.fromJS({ gr_ma_id: -1, gr_ma_area: 'Chưa có nhóm máy' })
        );
