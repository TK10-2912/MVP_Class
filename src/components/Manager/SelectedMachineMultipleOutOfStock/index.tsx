...
export interface IProps {
    ...
    isClear?: boolean;
    onClear?: () => void;
    listIdDisplay?: number[];
    onChangeMachine?: (item: number[] | undefined, key?: number | undefined) => void;
    groupMachineId?: number;
}
const { Option } = Select;
export default class SelectedMachineMultipleOutOfStock extends AppComponentBase<IProps> {
    state = {
        isLoading: false,
    ...
    async componentDidMount() {
        ...
        this.machineListResult = stores.sessionStore.getAllMachinesHasListID(this.props.listIdDisplay != undefined ? this.props.listIdDisplay : []);
